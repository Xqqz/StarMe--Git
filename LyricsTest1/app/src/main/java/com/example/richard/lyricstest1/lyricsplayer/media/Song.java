package com.example.richard.lyricstest1.lyricsplayer.media;
...
import com.example.richard.lyricstest1.bass.BASS;

import java.io.File;
import java.io.IOException;
import java.util.List;

import static com.example.richard.lyricstest1.bass.BASS.BASS_ChannelBytes2Seconds;
import static com.example.richard.lyricstest1.bass.BASS.BASS_ChannelGetLength;
import static com.example.richard.lyricstest1.bass.BASS.BASS_ChannelGetPosition;
import static com.example.richard.lyricstest1.bass.BASS.BASS_ChannelIsActive;
import static com.example.richard.lyricstest1.bass.BASS.BASS_ChannelPause;
import static com.example.richard.lyricstest1.bass.BASS.BASS_ChannelPlay;
import static com.example.richard.lyricstest1.bass.BASS.BASS_ChannelSeconds2Bytes;
import static com.example.richard.lyricstest1.bass.BASS.BASS_ChannelSetPosition;
import static com.example.richard.lyricstest1.bass.BASS.BASS_ChannelSetSync;
import static com.example.richard.lyricstest1.bass.BASS.BASS_ChannelStop;
import static com.example.richard.lyricstest1.bass.BASS.BASS_ErrorGetCode;
import static com.example.richard.lyricstest1.bass.BASS.BASS_POS_BYTE;
import static com.example.richard.lyricstest1.bass.BASS.BASS_SYNC_END;
import static com.example.richard.lyricstest1.bass.BASS.BASS_SYNC_POS;
import static com.example.richard.lyricstest1.bass.BASS.BASS_SampleFree;
import static com.example.richard.lyricstest1.bass.BASS.BASS_StreamCreateFile;
...
public class Song {
    ...
    public Song(String path, BASS.SYNCPROC onSongEnd) throws TagException, ReadOnlyFileException, CannotReadException, InvalidAudioFrameException, IOException {
        this.filePath = path;
