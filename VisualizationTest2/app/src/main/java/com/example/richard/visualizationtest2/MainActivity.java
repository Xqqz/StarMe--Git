package com.example.richard.visualizationtest2;
...
public class MainActivity extends AppCompatActivity {
    ...
    PlayerVisualizerView mVisualizerView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mVisualizerView = (PlayerVisualizerView) findViewById(R.id.myvisualizerview);
