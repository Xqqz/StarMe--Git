...
public class SongPlayer extends AppCompatActivity {
    ...
    final static double graphStartingX = -0.8;
    final static double graphEndingX = 0.4;
    private double orderNr =  graphStartingX;
...
//                                System.out.println(orderNr);
    ...
    private void initGraph(){
        ...
        graph.getViewport().setMinX(graphStartingX);
        graph.getViewport().setMaxX(graphEndingX); //mitu korraga näeb
...
//        mediaPlayer.prepare(); // might take long! (for buffering, etc)
    ...
    private void resetGraph(){
        ...
        graphViewPort.setMinX(graphStartingX);
        graphViewPort.setMaxX(graphEndingX);
        graph.invalidate();
        orderNr = graphEndingX;
    }
